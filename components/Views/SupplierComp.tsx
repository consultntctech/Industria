...
const SupplierComp = ({openNew, setOpenNew}:SupplierCompProps) => {
    ...
    <div className={`${openNew? 'flex':'hidden'} p-4 lg:p-8 rounded-2xl w-full`}>
        <form ref={formRef} onSubmit={handleSubmit}  className="formBox p-4 flex-col gap-8 w-full" >
            ...
            <div className="flex flex-col lg:flex-row gap-4 items-stretch">
                ...
                <InputWithLabel onChange={onChange} name="name" required placeholder="enter name" label="Company/Individual name" className="w-full" />
                <InputWithLabel onChange={onChange} name="person" required placeholder="enter name" label="Enter contact person's name" className="w-full" />
