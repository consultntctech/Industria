...
import { useFetchAvailableProditems } from "@/hooks/fetch/useFetchProditem";
import { IProdItem } from "@/lib/models/proditem.model";


type SearchSelectAvMultipleProdItemsProps = {
...
export default SearchSelectAvMultipleProdItems