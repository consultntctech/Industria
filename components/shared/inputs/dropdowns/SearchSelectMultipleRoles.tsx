...
type SearchSelectMultipleRolesProps = {
    setSelection:Dispatch<SetStateAction<IRole[]>>;
    fixedSelection?:IRole[];
    width?:number;
    required?:boolean;
    value?:IRole[];
    placeholder?:string;
...
const SearchSelectMultipleRoles = ({setSelection, fixedSelection, width, required, value, placeholder}:SearchSelectMultipleRolesProps) => {
...
export default SearchSelectMultipleRoles