...
type SearchSelectMultipleLabourersProps = {
    setSelection:Dispatch<SetStateAction<ILabourer[]>>;
    // selection:string[];
...
const SearchSelectMultipleLabourers = ({setSelection, width, required, value, placeholder}:SearchSelectMultipleLabourersProps) => {
    const [search, setSearch] = useState<string>('');
    const {labourers, isPending} = useFetchLabourers();
...
export default SearchSelectMultipleLabourers