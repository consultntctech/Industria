...
const DeptUserInfoModal = ({infoMode, setInfoMode, currentUser, setCurrentUser, refetch, isHod}:DeptUserInfoModalProps) => {
    ...
    const canSeeActions = (isGlobal || isAdmin || isHod) || !isG;
