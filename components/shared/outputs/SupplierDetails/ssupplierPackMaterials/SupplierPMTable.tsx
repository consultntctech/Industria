...
import { SupplierPMColumns } from "./SupplierPMColumns";

type SupplierPMTableProps = {
    isPending:boolean;
    materials:IProdItem[];
}

const SupplierPMTable = ({isPending, materials}:SupplierPMTableProps) => {
...
export default SupplierPMTable