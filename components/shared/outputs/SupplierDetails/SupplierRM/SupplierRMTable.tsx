...
import { SupplierRMColumns } from "./SupplierRMColumns";

type SupplierRMTable = {
    isPending:boolean;
    materials:IRMaterial[];
}

const SupplierRMTable = ({isPending, materials}:SupplierRMTable) => {
...
export default SupplierRMTable