...
import { ProdItemsColumn } from './ProdItemsColumn'

type ProdItemsTableProps = {
    setOpenNew:Dispatch<SetStateAction<boolean>>;
    setOpenItem:Dispatch<SetStateAction<boolean>>;
    production: IProduction | null;
}

const ProdItemsTable = ({setOpenNew, setOpenItem, production}:ProdItemsTableProps) => {

    const materials = production?.proditems as unknown as IProdItem[];
