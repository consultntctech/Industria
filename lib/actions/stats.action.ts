...
export async function getMonthlyTransactionSummaryByOrg(
    org: string,
    month?: number, // 1–12
    year?: number,
    type: "quantity" | "price" = "quantity"
...
export async function getMonthlyTransactionCountsByOrg(org:string): Promise<IResponse> {
    try {
        await connectDB();
...
export async function getOrderAndSalesStatsByOrg(org:string): Promise<IResponse> {
    try {
        await connectDB();
...
export async function getStatsByOrg(org:string): Promise<IResponse> {
  try {
    await connectDB();
...
export async function getGlobalFinanceStatsByOrg(org:string): Promise<IResponse> {
    try {
        await connectDB();
...
export async function getDashboardStatsByOrg(org:string): Promise<IResponse> {
    try {
        await connectDB();
